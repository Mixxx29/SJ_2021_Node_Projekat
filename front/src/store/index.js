  ...
  actions: {
    getAppointments: function ({commit}, date) {
      return new Promise((resolve => {
        fetch(`https://sj-projekat-api.herokuapp.com/user/appointments/${date}`).then(result => {
    ...
    login: function ({commit}, form) {
      return new Promise((resolve, reject) => {
        fetch('https://sj-projekat-auth.herokuapp.com/login', {
          method: 'POST',
          headers: {
    ...
    register: function ({commit}, form) {
      return new Promise((resolve, reject) => {
        ...
        fetch('https://sj-projekat-auth.herokuapp.com/register', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
